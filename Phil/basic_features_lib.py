#----------------------------------------------
# Disclaimer
# All methods are in general programmed by P. Balczukat
# Online sources like Stackoverflow and ChatGPT supported
# me to find the right OPenCV-Method to fullfill the task
#----------------------------------------------
